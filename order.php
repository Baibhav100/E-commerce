...
$total_price = 0;
$cart_query_price = "select * from `cart_info` where ip_address='$get_ip_address'";
...
$get_cart = "select * from `cart_info`";
...
if($result_query)
{
    ...
    echo "<script>window.open('user_panel/profile.php','_self')</script>";
}
//orders pending
...
$empty_cart="delete from `cart_info` where ip_address='$get_ip_address'";
